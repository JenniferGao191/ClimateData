...
datetime = reshape(datetime,length(file_names),1)

% 将文件名、变量名、变量值和变量含义合并为一个cell数组
data = [file_names, datetime, variable_names, num2cell(variable_values), variable_meaning];
